...
import { i as getSafeWindow } from "./browser-safe-DPMYmjS3.mjs";
import { n as SectionHeader, t as AppShell } from "./AppShell-5p7JScr3.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/nutrition-CIIilOlN.js
...
function NutritionPage() {
	...
	(0, import_react.useEffect)(() => {
		...
		win?.addEventListener("zenvita:open-meal-log", openMealHandler);
		return () => {
			win?.removeEventListener("zenvita:open-meal-log", openMealHandler);
		};
	}, []);
