...
//#region node_modules/.nitro/vite/services/ssr/assets/sleep-COx7uSN2.js
...
function SleepPage() {
	...
	(0, import_react.useEffect)(() => {
		...
		win?.addEventListener("zenvita:open-sleep-log", openHandler);
		return () => {
			win?.removeEventListener("zenvita:open-sleep-log", openHandler);
		};
	}, []);
