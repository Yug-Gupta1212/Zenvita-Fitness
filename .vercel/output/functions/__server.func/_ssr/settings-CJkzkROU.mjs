...
//#region node_modules/.nitro/vite/services/ssr/assets/settings-CJkzkROU.js
	...
	(0, import_react.useEffect)(() => {
		const loadProfile = async () => {
			...
			if (data.session) {
				...
				setUnits(localStorage.getItem("zenvita_pref_units") || "Metric");
				setLanguage(localStorage.getItem("zenvita_pref_language") || "English");
				setDarkMode((localStorage.getItem("zenvita-theme") || "dark") === "dark");
			}
		};
		loadProfile();
	}, []);
